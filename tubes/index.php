...
<body>
        ...
        <div id="navbarBasicExample" class="navbar-menu">
            <div class="navbar-start">
                <div class="navbar-menu py-2 pr-3">
                    <a href="index.php" class="button is-dark has-text-weight-semibold">
                        Home
                    </a>
                </div>
                <div class="navbar-menu py-2">
                    <a href="config/addData.php" class="button is-dark has-text-weight-semibold">
                        Input Data
                    </a>
                </div>
            </div>
    ...
    <div class="container py-6" id="container">
        <table id="dataTable" class="table" style="width:100%; padding:0; margin:0;">
            <thead>
                <tr>
