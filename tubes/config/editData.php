            ...
            <div class="container">
                <div class="columns is-centered">
                    <div class="column is-5-tablet is-4-desktop is-3-widescreen">
                        ...
                        <input type="hidden" name="oldIMG" id="id" value="<?= $item['itemsIMG']; ?>">
                            <div class="field">
                                <label for="itemsName" class="label">Item Name</label>
                                <div class="control has-icons-left">
                                    <input type="text" class="input" name="itemsName" id="itemsName" required value="<?= $item['itemsName']; ?>">
                            ...
                            <div class="field">
                                ...
                                <div class="control has-icons-left">
                                    <input type="text" class="input" name="itemsColor" id="itemsColor" required value="<?= $item['itemsColor']; ?>">
                                    <span class="icon is-small is-left">
                            ...
                            <div class="field">
                                ...
                                <div class="control has-icons-left">
                                    <input type="text" class="input" name="itemsPrice" id="itemsPrice" required value="<?= $item['itemsPrice']; ?>">
                                    <span class="icon is-small is-left">
                            ...
                            <div class="field">
                                ...
                                <div class="control has-icons-left">
                                    <input type="text" class="input" name="itemsStock" id="itemsStock" required value="<?= $item['itemsStock']; ?>">
                                    <span class="icon is-small is-left">
                            ...
                            <br>
                            <div class="field">
                                <button type="submit" class="button is-info" name="editData">Submit</button>
                                <a href="../admin/dashboard.php" class="button is-light">Cancel</a>
                            </div>
                        </form>
                    </div>
                </div>
